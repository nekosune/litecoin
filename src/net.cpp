...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Equestriacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"equestriaco.in", "dnsseed.equestriaco.in"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"equestriaco.in", "testnet-dnsseed.equestriaco.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Equestriacoin is probably already running."), addrBind.ToString().c_str());
        else
